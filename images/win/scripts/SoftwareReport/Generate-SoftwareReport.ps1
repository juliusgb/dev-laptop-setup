...
# Not used and therefore removed: LLVM, PHP
...
# CUSTOM: removed cos not used: Composer, Helm
...
# CUSTOM: removed cos not used: sbt

# Tools
$tools = $installedSoftware.AddHeader("Tools")
$tools.AddToolVersion("7zip", $(Get-7zipVersion))
$tools.AddToolVersion("aria2", $(Get-Aria2Version))
# CUSTOM: removed cos not used: AzCopy,Bazel, Bazelisk,Bicep, Cabal, CodeQLBundle
...
# CUSTOM: removed cos not used: kind, kubectl, Mercurial, Get-NSISVersion
...
# CUSTOM: removed cos not used: Service Fabric SDK, Stack, Subversion, Swig, VSWhere, WinAppDriver, WiX Toolset
$tools.AddToolVersion("yamllint", $(Get-YAMLLintVersion))
$tools.AddToolVersion("zstd", $(Get-ZstdVersion))

# CLI Tools
$cliTools = $installedSoftware.AddHeader("CLI Tools")
# CUSTOM: removed cos not used: Alibaba Cloud CLI
...
# Rust Tools. CUSTOM: removed cos not used
# Browsers and Drivers. CUSTOM: removed cos not used
...
# CUSTOM: removed cos not used: Azure CosmosDb Emulator, DacFx, MySQL, SQL OLEDB Driver, SQLPS

# Web Servers
$installedSoftware.AddHeader("Web Servers").AddTable($(Build-WebServersSection))

# Visual Studio. CUSTOM: removed cos not used.
# .NET Core Tools
...
# CUSTOM: removed cos not used: AzureRM PowerShell module

# Android.  CUSTOM: removed cos not used

# Cached Docker images
#$installedSoftware.AddHeader("Cached Docker images").AddTable($(Get-CachedDockerImagesTableData))

# Generate reports
$softwareReport.ToJson() | Out-File -FilePath "C:\opt\software-report.json" -Encoding UTF8NoBOM
$softwareReport.ToMarkdown() | Out-File -FilePath "C:\opt\software-report.md" -Encoding UTF8NoBOM
